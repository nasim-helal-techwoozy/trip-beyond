...
const PaymentRequest = () => {
  const [depositType, setDepositType] = useState<{ value: string; label: string } | null>(null);
    ...
    <>
      <form onSubmit={handleFormSubmit} className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div className="flex flex-col">
          <label htmlFor="depositType" className="text-gray-600 mb-2 text-sm font-semibold">
            Deposit Type*
          </label>
          <Select
            id="depositType"
        ...
        {/* Attachment */}
        <div className="flex flex-col">
          <label htmlFor="attachment" className="text-gray-600 mb-2 text-sm font-semibold">
