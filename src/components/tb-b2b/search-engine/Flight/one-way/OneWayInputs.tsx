...
const OneWayInputs = () => {
  ...
  return (
    <div className="grid grid-cols-4 gap-12 items-center relative">
      {/* From Input */}
      ...
      {/* Swap Button */}
      <Button
        className="absolute left-1/4 -translate-x-[60%] top-1/2 -translate-y-[50%] p-1 size-[30px] aspect-square rounded-full z-10 ring-1 ring-secondary-main"
        onClick={() => {
      ...
      <div className="flex flex-col items-center relative">
        ...
        />
        {/* Vertical Line */}
        <div className="absolute right-[-15px] top-0 bottom-0 w-[1px] bg-slate-700"></div>
      </div>
