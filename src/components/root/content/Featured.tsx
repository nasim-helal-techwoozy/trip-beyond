  ...
  return (
    <div className="space-y-4 w-full max-w-5xl mx-auto mb-5 p-5">
      ...
      <KeepDescription>
        ...
        corporate travel account, Tripbeyond.com is here to help you travel the
        world with cheap fights, discount hotels, and train tickets. Looking to
        find great travel deals or enjoy the biggest savings on your next trip?
        Trip.com has you covered. With our easy-to-use website and app, along
        with 24-hour customer service, booking your next trip couldn&apos;t be
        simpler. With Tripbeyond.com, quality travel services in over a dozen
      ...
      <KeepDescription>
        ...
        calendar, and early bird deals. Tripbeyond.com&apos;s secure payment
        system takes the stress out of travel by providing easy payment options,
      ...
      <KeepDescription>
        ...
        Osaka | Hotels in Kyoto | Hotels in Fukuoka | Hotels in Sapporo | Hotels
      ...
      <KeepDescription>
        ...
        Fnormal text-gray-500s to Ho Chi Minh | Fnormal text-gray-500s to Osaka
        | Fnormal text-gray-500s to Shenzhen | Fnormal text-gray-500s to
        Shanghai | Fnormal text-gray-500s to Beijing | Fnormal text-gray-500s to
        Hong Kong | Fnormal text-gray-500s to Seoul | Fnormal text-gray-500s to
        Bangkok | Fnormal text-gray-500s to Taipei | Fnormal text-gray-500s to
        Singapore | Fnormal text-gray-500s to Tokyo | Fnormal text-gray-500s to
      ...
      <KeepDescription>
        ...
        Observation Deck Ticket | Statue of Liberty Cruise | Kualoa Ranch Day
        Tour
      </KeepDescription>
    </div>
  );
