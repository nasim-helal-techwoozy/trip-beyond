...
const AgentSignup = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-blue-300 via-orange-300 to-indigo-300 px-4">
            ...
            >
                <h2 className="text-2xl font-semibold text-center">Agency Registration</h2>
                    ...
                    <div className="w-full">
                        ...
                        <Select
                            ...
                            value={cityOptions.find(
                                (option) => option.value === agent.city
                            )}
                            onChange={(selectedOption) =>
                ...
                <div className="flex justify-center mt-4">
                    <Button
                        type="submit"
                        className="bg-primary-500 hover:shadow-2xl text-white font-semibold py-2 px-4 rounded-full"
                    >
                        Submit
                    </Button>
                </div>
