    ...
    <section className="mx-10 space-y-5">
      <div className="text-center py-5">
        <KeepDescription>
          ...
          unparalleled adventures. From secluded beaches to majestic peaks, our
          expert team crafts tailor-made journeys that redefine travel. Immerse
          yourself in culture, savor unique experiences, and create memories
          that last a lifetime. Join us and journey beyond the ordinary with
          Trip Beyond.
        </KeepDescription>
